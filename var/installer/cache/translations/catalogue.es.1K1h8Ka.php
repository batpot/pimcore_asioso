...
$catalogue = new MessageCatalogue('es', array (
  ...
  array (
    ...
    'This file is not a valid video.' => 'Este archivo no es un video válido.',
    'The size of the video could not be detected.' => 'No se pudo detectar el tamaño del video.',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'El ancho del vídeo es demasiado grande ({{ width }}px). El ancho máximo permitido es {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'El ancho del video es demasiado pequeño ({{ width }}px). El ancho mínimo esperado es {{ min_width }}px.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'La altura del video es demasiado grande ({{ height }}px). La altura máxima permitida es {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'La altura del video es demasiado pequeña ({{ height }}px). La altura mínima esperada es {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'El vídeo tiene muy pocos píxeles ({{ pixels }}). La cantidad mínima esperada es {{ min_pixels }}.',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'El vídeo tiene demasiados píxeles ({{ pixels }}). La cantidad máxima esperada es {{ max_pixels }}.',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'La relación del video es demasiado grande ({{ ratio }}). La relación máxima permitida es {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'La relación del video es demasiado pequeña ({{ ratio }}). La relación mínima esperada es {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'El video es cuadrado ({{ width }}x{{ height }}px). No se permiten videos cuadrados.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'El video tiene orientación horizontal ({{ width }}x{{ height }} px). No se permiten videos en formato horizontal.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'El video tiene orientación vertical ({{ width }}x{{ height }} px). No se permiten videos en orientación vertical.',
    'The video file is corrupted.' => 'El archivo de video está dañado.',
    'The video contains multiple streams. Only one stream is allowed.' => 'El video contiene múltiples flujos. Solo se permite un flujo.',
    'Unsupported video codec "{{ codec }}".' => 'Códec de vídeo no compatible «{{ codec }}».',
    'Unsupported video container "{{ container }}".' => 'Contenedor de vídeo no compatible "{{ container }}".',
    'The image file is corrupted.' => 'El archivo de imagen está dañado.',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'La imagen tiene muy pocos píxeles ({{ pixels }}). La cantidad mínima esperada es {{ min_pixels }}.',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'La imagen tiene demasiados píxeles ({{ pixels }}). La cantidad máxima esperada es {{ max_pixels }}.',
    'This filename does not match the expected charset.' => 'Este nombre de archivo no coincide con el conjunto de caracteres esperado.',
  ),
  'security' => 
  array (
