...
class __TwigTemplate_6ab78682dbba4b2f62b8fa21427edf9d extends Template
{
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        // line 5
        yield "    ";
        yield Twig\Extension\CoreExtension::include($this->env, $context, "includes/hero-carousel.html.twig");
        yield "
    <div id=\"portal\" class=\"portal-page\">
        ";
        // line 7
        yield $this->extensions['Pimcore\Twig\Extension\DocumentEditableExtension']->renderEditable($context, "areablock", "content", ["allowed" => ["hero-teaser", "standard-teaser", "hero-grid", "product-teaser", "gallery-carousel", "horizontal-line", "image", "image-hotspot-marker", "video", "personalized-product-teaser"]]);
        // line 9
        yield "
    </div>
";
    ...
    {
        return array (  88 => 9,  86 => 7,  80 => 5,  78 => 4,  65 => 3,  42 => 1,);
    }
...
{% endblock %}", "content/portal.html.twig", "/home/batpot/skeleton-project/templates/content/portal.html.twig");
    }
    ...
    public function checkSecurity()
    {
        ...
        static $filters = [];
        static $functions = ["include" => 5, "pimcore_areablock" => 7];

        try {
            $this->sandbox->checkSecurity(
                ['extends'],
                [],
                ['include', 'pimcore_areablock'],
                $this->source
            );
