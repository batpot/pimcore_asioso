...
class __TwigTemplate_1f00a44231974b590ae5c47e66561364 extends Template
{
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
                ...
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, true, 103) || (CoreExtension::getAttribute($this->env, $this->source, $context["listener"], "event", [], "any", false, false, true, 103) != (isset($context["previous_event"]) || array_key_exists("previous_event", $context) ? $context["previous_event"] : (function () { throw new RuntimeError('Variable "previous_event" does not exist.', 103, $this->source); })())))) {
                    // line 104
                    yield "                ";
                    if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, true, 104)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 105
                        yield "                    </tbody>
                ";
                    }
            ...
            ";
                // line 121
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, true, 121)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 122
                    yield "                </tbody>
            ";
                }
...
{% endmacro %}
", "@WebProfiler/Collector/events.html.twig", "/home/batpot/skeleton-project/vendor/symfony/web-profiler-bundle/Resources/views/Collector/events.html.twig");
    }
