...
class __TwigTemplate_39faeec49258adc3a94dba6b8f6cb565 extends Template
{
...
<html>
    <head>
        ...
        yield ">
            ";
        // line 8
        if ((($tmp = (isset($context["tab"]) || array_key_exists("tab", $context) ? $context["tab"] : (function () { throw new RuntimeError('Variable "tab" does not exist.', 8, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 9
...
", "@PimcoreAdmin/admin/login/deeplink.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/admin-ui-classic-bundle/templates/admin/login/deeplink.html.twig");
    }
