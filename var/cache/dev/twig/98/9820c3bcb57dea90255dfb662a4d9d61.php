...
class __TwigTemplate_cdfc543b0531f6dcfc70eb0c3b80748f extends Template
{
...
";
        // line 16
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(Twig\Extension\CoreExtension::trim((isset($context["deeplink"]) || array_key_exists("deeplink", $context) ? $context["deeplink"] : (function () { throw new RuntimeError('Variable "deeplink" does not exist.', 16, $this->source); })())))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 17
            yield "    <a href=\"";
...
";
        // line 21
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(Twig\Extension\CoreExtension::trim((isset($context["note_description"]) || array_key_exists("note_description", $context) ? $context["note_description"] : (function () { throw new RuntimeError('Variable "note_description" does not exist.', 21, $this->source); })())))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 22
            yield "    <strong>";
...
</html>", "@PimcoreCore/Workflow/NotificationEmail/notificationEmail.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/pimcore/bundles/CoreBundle/templates/Workflow/NotificationEmail/notificationEmail.html.twig");
    }
