...
class __TwigTemplate_a972fb65b2bb5428083dc8dde60510c8 extends Template
{
    ...
    <table>
        ...
        ";
        // line 19
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["language"]) || array_key_exists("language", $context) ? $context["language"] : (function () { throw new RuntimeError('Variable "language" does not exist.', 19, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 20
            yield "            <tr>
                <th>";
            // line 21
        ...
        if ($this->env->getTest('instanceof')->getCallable()((isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 29, $this->source); })()), "\\Pimcore\\Model\\Document\\Page")) {
            // line 30
            yield "            ";
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 30, $this->source); })()), "title", [], "any", false, false, true, 30))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 31
                yield "            <tr>
                <th>";
                // line 32
            ...
            ";
            // line 37
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 37, $this->source); })()), "description", [], "any", false, false, true, 37))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 38
                yield "                <tr>
                    <th>";
                // line 39
            ...
            ";
            // line 44
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 44, $this->source); })()), "getProperty", ["navigation_name"], "method", false, false, true, 44))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 45
                yield "                <tr>
                    <th>";
                // line 46
        ...
        // line 53
        yield "        ";
        $context["owner"] = (((($tmp =  !(null === (isset($context["userOwnerId"]) || array_key_exists("userOwnerId", $context) ? $context["userOwnerId"] : (function () { throw new RuntimeError('Variable "userOwnerId" does not exist.', 53, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (Pimcore\Model\User::getById($this->sandbox->ensureToStringAllowed((isset($context["userOwnerId"]) || array_key_exists("userOwnerId", $context) ? $context["userOwnerId"] : (function () { throw new RuntimeError('Variable "userOwnerId" does not exist.', 53, $this->source); })()), 53, $this->source))) : (null));
        // line 54
        yield "        ";
...
", "@PimcoreAdmin/searchadmin/search/quicksearch/info_table.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/admin-ui-classic-bundle/templates/searchadmin/search/quicksearch/info_table.html.twig");
    }
