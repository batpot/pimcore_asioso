...
class __TwigTemplate_28cb433e0d2da71e5e9d55f669a505f1 extends Template
{
    ...
    ";
        ...
        <div class=\"sf-tabs js-tabs\">
            ...
            foreach ($context['_seq'] as $context["name"] => $context["data"]) {
                ...
                if ((($tmp = Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["data"], "calls", [], "any", false, false, true, 253))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    yield " (";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["call"]) {
                    ...
                    yield "()</code>
                                            ";
                    // line 282
                    if ((($tmp = (((CoreExtension::getAttribute($this->env, $this->source, $context["call"], "previousMarking", [], "any", true, true, true, 282) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, $context["call"], "previousMarking", [], "any", false, false, true, 282)))) ? (CoreExtension::getAttribute($this->env, $this->source, $context["call"], "previousMarking", [], "any", false, false, true, 282)) : (null))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 283
                        yield "                                                <hr />
                                                Previous marking:
                                                ";
...
{% endblock %}
", "@WebProfiler/Collector/workflow.html.twig", "/home/batpot/skeleton-project/vendor/symfony/web-profiler-bundle/Resources/views/Collector/workflow.html.twig");
    }
