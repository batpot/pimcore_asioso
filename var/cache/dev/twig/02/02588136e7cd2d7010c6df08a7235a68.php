...
class __TwigTemplate_306ad06a0f9ba404e972c339ad462946 extends Template
{
...
<table id=\"wrapper\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">
    <tr>
        ...
        yield "                            </td>
                        ...
                        ";
        // line 72
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["asset"]) || array_key_exists("asset", $context) ? $context["asset"] : (function () { throw new RuntimeError('Variable "asset" does not exist.', 72, $this->source); })()), "getHasMetadata", [], "method", false, false, true, 72)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 73
            yield "                            ";
...
", "@PimcoreAdmin/admin/asset/show_version_image.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/admin-ui-classic-bundle/templates/admin/asset/show_version_image.html.twig");
    }
