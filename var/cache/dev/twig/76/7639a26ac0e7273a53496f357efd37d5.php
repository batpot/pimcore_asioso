...
class __TwigTemplate_11bcc9e5135408da03234633ce7cdf86 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        if (($this->env->getTest('instanceof')->getCallable()((isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 3, $this->source); })()), "\\Pimcore\\Model\\Document\\Page") && (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["config"]) || array_key_exists("config", $context) ? $context["config"] : (function () { throw new RuntimeError('Variable "config" does not exist.', 3, $this->source); })()), "documents", [], "array", false, false, true, 3), "generate_preview", [], "array", false, false, true, 3) == true))) {
            ...
            // line 5
            yield "    ";
            if ((($tmp = $this->env->getFunction('pimcore_file_exists')->getCallable()((isset($context["thumbnailFile"]) || array_key_exists("thumbnailFile", $context) ? $context["thumbnailFile"] : (function () { throw new RuntimeError('Variable "thumbnailFile" does not exist.', 5, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 6
                yield "        ";
...
";
        ...
        ";
            // line 13
            yield from $this->load("@PimcoreAdmin/searchadmin/search/quicksearch/info_table.html.twig", 13)->unwrap()->yield(CoreExtension::merge($context, ["element" => (isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 13, $this->source); })())]));
            // line 14
            yield "    </div>
";
        } else {
    ...
    ";
            // line 17
            yield from $this->load("@PimcoreAdmin/searchadmin/search/quicksearch/info_table.html.twig", 17)->unwrap()->yield(CoreExtension::merge($context, ["element" => (isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 17, $this->source); })())]));
        }
...
{% else %}
    ...
    {% include '@PimcoreAdmin/searchadmin/search/quicksearch/info_table.html.twig' with {'element': element} %}
{% endif %}
", "@PimcoreAdmin/searchadmin/search/quicksearch/document.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/admin-ui-classic-bundle/templates/searchadmin/search/quicksearch/document.html.twig");
    }
