...
class __TwigTemplate_b7d64347d46f2cef77ae1fc62b9e378c extends Template
{
...
";
        ...
        ";
            // line 16
            yield from $this->load("@PimcoreAdmin/searchadmin/search/quicksearch/info_table.html.twig", 16)->unwrap()->yield(CoreExtension::merge($context, ["element" => (isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 16, $this->source); })())]));
            // line 17
            yield "    </div>
";
        } else {
    ...
    ";
            // line 20
            yield from $this->load("@PimcoreAdmin/searchadmin/search/quicksearch/info_table.html.twig", 20)->unwrap()->yield(CoreExtension::merge($context, ["element" => (isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 20, $this->source); })())]));
        }
        // line 22
        yield "
";
...
", "@PimcoreAdmin/searchadmin/search/quicksearch/asset.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/admin-ui-classic-bundle/templates/searchadmin/search/quicksearch/asset.html.twig");
    }
