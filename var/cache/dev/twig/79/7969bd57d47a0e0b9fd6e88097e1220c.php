...
class __TwigTemplate_afb4c51233f85764dee6e05e6fc809e6 extends Template
{
...
";
    ...
    public function macro_render_migration($migration = null, $profiler_markup_version = null, ...$varargs): string|Markup
    {
        ...
        <td class=\"font-normal\">
            ";
            // line 225
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["migration"]) || array_key_exists("migration", $context) ? $context["migration"] : (function () { throw new RuntimeError('Variable "migration" does not exist.', 225, $this->source); })()), "file", [], "any", false, false, true, 225)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 226
                yield "                <a href=\"";
        ...
        <td class=\"font-normal align-right\">
            ";
            // line 233
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["migration"]) || array_key_exists("migration", $context) ? $context["migration"] : (function () { throw new RuntimeError('Variable "migration" does not exist.', 233, $this->source); })()), "is_new", [], "any", false, false, true, 233)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 234
                yield "                <span class=\"";
...
(isset($context["migration"]) || array_key_exists("migration", $context) ? $context["migration"] : (function () { throw new RuntimeError('Variable "migration" does not exist.', 235, $this->source); })()), "is_unavailable", [], "any", false, false, true, 235)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 236
                yield "                <span class=\"";
...
{% endmacro %}
", "@DoctrineMigrations/Collector/migrations.html.twig", "/home/batpot/skeleton-project/vendor/doctrine/doctrine-migrations-bundle/templates/Collector/migrations.html.twig");
    }
