...
class __TwigTemplate_9de9fa1c2704c5e4fc62b77d17610cc2 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        // line 1
        if ((($tmp =  !(isset($context["headless"]) || array_key_exists("headless", $context) ? $context["headless"] : (function () { throw new RuntimeError('Variable "headless" does not exist.', 1, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 2
            yield "<!DOCTYPE html>
<html>
<head>
...
";
        // line 138
        if ((($tmp =  !(isset($context["headless"]) || array_key_exists("headless", $context) ? $context["headless"] : (function () { throw new RuntimeError('Variable "headless" does not exist.', 138, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 139
            yield "</body>
</html>";
        }
    ...
    <tr>
        <td>
            ";
            // line 21
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["check"]) || array_key_exists("check", $context) ? $context["check"] : (function () { throw new RuntimeError('Variable "check" does not exist.', 21, $this->source); })()), "link", [], "any", false, false, true, 21))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 22
                yield "                <a href=\"";
...
{%- endif %}
", "@PimcoreAdmin/admin/install/check.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/admin-ui-classic-bundle/templates/admin/install/check.html.twig");
    }
