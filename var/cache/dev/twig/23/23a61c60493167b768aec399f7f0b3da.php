...
class __TwigTemplate_debbfca443a7e0480a07b27081711f24 extends Template
{
...
<table class=\"preview\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">
    <tr>
        ...
        <th>";
        // line 17
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Value", [], "admin"), "html", null, true);
        yield "</th>
    </tr>
    <tr class=\"system\">
        <td>";
    ...
    <tr class=\"system\">
        ...
        <td>";
        // line 32
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 32, $this->source); })()), "getPublished", [], "method", false, false, true, 32)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("true") : ("false"));
        yield "</td>
    </tr>
    ";
        // line 34
        if ((($tmp = (isset($context["versionNote"]) || array_key_exists("versionNote", $context) ? $context["versionNote"] : (function () { throw new RuntimeError('Variable "versionNote" does not exist.', 34, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 35
        ...
        foreach ($context['_seq'] as $context["fieldName"] => $context["definition"]) {
            ...
            if ($this->env->getTest('instanceof')->getCallable()($context["definition"], "\\Pimcore\\Model\\DataObject\\ClassDefinition\\Data\\Localizedfields")) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["lfd"]) {
                        ...
                        <td>
                                ";
                        // line 53
                        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 53, $this->source); })()), "getValueForFieldName", [$context["fieldName"]], "method", false, false, true, 53)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                            // line 54
                            yield "                                    ";
                ...
                ";
                    ...
                    ";
                        // line 70
                        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["brick"]) || array_key_exists("brick", $context) ? $context["brick"] : (function () { throw new RuntimeError('Variable "brick" does not exist.', 70, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                            // line 71
                            yield "                        ";
                                ...
                                foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
                                    ...
                                    foreach ($context['_seq'] as $context["_key"] => $context["localizedFieldDefinition"]) {
                                        ...
                                        <td>
                                            ";
                                        // line 81
                                        if ((($tmp = (isset($context["brickValue"]) || array_key_exists("brickValue", $context) ? $context["brickValue"] : (function () { throw new RuntimeError('Variable "brickValue" does not exist.', 81, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                                            // line 82
                                            yield "                                                ";
            ...
            ";
                // line 108
                if ((($tmp = (isset($context["storedata"]) || array_key_exists("storedata", $context) ? $context["storedata"] : (function () { throw new RuntimeError('Variable "storedata" does not exist.', 108, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 109
                    yield "                ";
                ...
                // line 111
                yield "            ";
                if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["activeGroups"]) || array_key_exists("activeGroups", $context) ? $context["activeGroups"] : (function () { throw new RuntimeError('Variable "activeGroups" does not exist.', 111, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 112
                    yield "                ";
                    $context["languages"] = ["default"];
                    // line 113
                    yield "                ";
                    if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["definition"], "isLocalized", [], "method", false, false, true, 113)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 114
                        yield "                    ";
                ...
                ";
                    ...
                    foreach ($context['_seq'] as $context["activeGroupId"] => $context["enabled"]) {
                        ...
                        // line 119
                        yield "                    ";
                        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["groupDefinition"]) || array_key_exists("groupDefinition", $context) ? $context["groupDefinition"] : (function () { throw new RuntimeError('Variable "groupDefinition" does not exist.', 119, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                            // line 120
                            yield "                        ";
                        ...
                        ";
                            ...
                            ";
                                // line 125
                                if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["keyDef"]) || array_key_exists("keyDef", $context) ? $context["keyDef"] : (function () { throw new RuntimeError('Variable "keyDef" does not exist.', 125, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                                    // line 126
                                    yield "                                ";
                                    $context['_parent'] = $context;
                                    ...
                                    ";
                                        ...
                                        yield " ";
                                        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["definition"], "isLocalized", [], "method", false, false, true, 132)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(("/ " . $this->sandbox->ensureToStringAllowed($context["language"], 132, $this->source)), "html", null, true)) : (""));
                                        yield "</td>
                                        ";
                                        // line 133
            ...
            ";
                // line 148
                if ((($tmp = (isset($context["fields"]) || array_key_exists("fields", $context) ? $context["fields"] : (function () { throw new RuntimeError('Variable "fields" does not exist.', 148, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 149
                    yield "                ";
...
";
    ...
    {
        return array (  788 => 186,  774 => 185,  768 => 182,  764 => 181,  760 => 180,  753 => 179,  750 => 178,  747 => 177,  741 => 176,  727 => 175,  721 => 172,  717 => 171,  713 => 170,  706 => 169,  703 => 168,  700 => 167,  694 => 166,  677 => 163,  669 => 162,  663 => 161,  656 => 160,  638 => 159,  633 => 158,  630 => 157,  612 => 156,  609 => 155,  604 => 154,  602 => 153,  599 => 152,  596 => 151,  593 => 150,  590 => 149,  588 => 148,  585 => 147,  582 => 146,  579 => 145,  576 => 144,  573 => 143,  570 => 142,  564 => 141,  561 => 140,  555 => 139,  552 => 138,  537 => 136,  531 => 134,  529 => 133,  523 => 132,  519 => 131,  512 => 130,  510 => 129,  507 => 128,  504 => 127,  486 => 126,  484 => 125,  481 => 124,  478 => 123,  474 => 122,  471 => 121,  468 => 120,  465 => 119,  462 => 118,  458 => 117,  455 => 116,  452 => 115,  449 => 114,  446 => 113,  443 => 112,  440 => 111,  437 => 110,  434 => 109,  432 => 108,  429 => 107,  426 => 106,  423 => 105,  420 => 104,  414 => 103,  399 => 101,  396 => 100,  390 => 97,  386 => 96,  382 => 95,  375 => 94,  372 => 93,  369 => 92,  366 => 91,  363 => 90,  357 => 89,  341 => 86,  335 => 84,  332 => 83,  329 => 82,  327 => 81,  322 => 79,  316 => 78,  309 => 77,  291 => 76,  286 => 75,  284 => 74,  281 => 73,  278 => 72,  275 => 71,  273 => 70,  270 => 69,  267 => 68,  265 => 67,  262 => 66,  259 => 65,  242 => 64,  239 => 63,  236 => 62,  231 => 61,  228 => 60,  222 => 59,  206 => 56,  200 => 54,  198 => 53,  193 => 51,  187 => 50,  180 => 49,  162 => 48,  157 => 47,  154 => 46,  137 => 45,  131 => 41,  125 => 38,  120 => 36,  117 => 35,  115 => 34,  110 => 32,  105 => 30,  99 => 27,  94 => 25,  88 => 22,  83 => 20,  77 => 17,  73 => 16,  69 => 15,  64 => 12,  62 => 11,  50 => 1,);
    }
...
", "@PimcoreAdmin/admin/data_object/data_object/preview_version.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/admin-ui-classic-bundle/templates/admin/data_object/data_object/preview_version.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = ["set" => 11, "if" => 34, "for" => 45];
        static $filters = ["escape" => 15, "trans" => 15, "date" => 22, "nl2br" => 38, "raw" => 54, "capitalize" => 67, "merge" => 114, "filter" => 117, "length" => 153];
        ...
        try {
            $this->sandbox->checkSecurity(
                ['set', 'if', 'for'],
                ['escape', 'trans', 'date', 'nl2br', 'raw', 'capitalize', 'merge', 'filter', 'length'],
