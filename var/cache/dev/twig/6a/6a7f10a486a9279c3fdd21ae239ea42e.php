...
class __TwigTemplate_c35ae6fef0e5b484a1214b951de4d1f7 extends Template
{
...
<html>
    ...
    <body class=\"pimcore_version_11 ";
        // line 17
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["adminSettings"]) || array_key_exists("adminSettings", $context) ? $context["adminSettings"] : (function () { throw new RuntimeError('Variable "adminSettings" does not exist.', 17, $this->source); })()), "branding", [], "array", false, false, true, 17), "login_screen_invert_colors", [], "array", false, false, true, 17)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("inverted") : (""));
        yield "\">
        <style>
            #background {
        ...
        // line 25
        yield "        ";
        if ((($tmp = (!Twig\Extension\CoreExtension::testEmpty((isset($context["customColor"]) || array_key_exists("customColor", $context) ? $context["customColor"] : (function () { throw new RuntimeError('Variable "customColor" does not exist.', 25, $this->source); })())))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 26
            yield "        <style>
            #content button {
                background: ";
        ...
        yield "\" src=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("pimcore_settings_display_custom_logo") . (((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["adminSettings"]) || array_key_exists("adminSettings", $context) ? $context["adminSettings"] : (function () { throw new RuntimeError('Variable "adminSettings" does not exist.', 38, $this->source); })()), "branding", [], "array", false, false, true, 38), "login_screen_invert_colors", [], "array", false, false, true, 38)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("") : ("?white=true"))), "html", null, true);
        yield "\">
        </div>
...
", "@PimcoreAdmin/admin/login/layout.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/admin-ui-classic-bundle/templates/admin/login/layout.html.twig");
    }
