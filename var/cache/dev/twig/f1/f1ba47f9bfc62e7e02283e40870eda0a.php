...
class __TwigTemplate_21dd034d2eca638e307b03510627d329 extends Template
{
...
";
        ...
        <div class=\"pimcore_area_buttons\" ";
            ...
            yield "></div>
                ...
                ";
            // line 25
            if ((($tmp = (isset($context["editableDialog"]) || array_key_exists("editableDialog", $context) ? $context["editableDialog"] : (function () { throw new RuntimeError('Variable "editableDialog" does not exist.', 25, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 26
        ...
        ";
            // line 33
            if ((($tmp = (isset($context["editableDialog"]) || array_key_exists("editableDialog", $context) ? $context["editableDialog"] : (function () { throw new RuntimeError('Variable "editableDialog" does not exist.', 33, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 34
...
{% endif %}
", "@PimcoreCore/Areabrick/wrapper.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/pimcore/bundles/CoreBundle/templates/Areabrick/wrapper.html.twig");
    }
