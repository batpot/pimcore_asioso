...
class __TwigTemplate_c54e6f45a871fc1bdedaec1814f6d14c extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->load("@PimcoreAdmin/admin/login/layout.html.twig", 1);
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp =  !(isset($context["browserSupported"]) || array_key_exists("browserSupported", $context) ? $context["browserSupported"] : (function () { throw new RuntimeError('Variable "browserSupported" does not exist.', 4, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
...
";
        // line 28
        if ((($tmp =  !(isset($context["browserSupported"]) || array_key_exists("browserSupported", $context) ? $context["browserSupported"] : (function () { throw new RuntimeError('Variable "browserSupported" does not exist.', 28, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 29
...
";
    ...
    ";
        // line 48
        if ((($tmp =  !array_key_exists("deeplink", $context)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 49
    ...
    ";
        // line 90
        if ((($tmp =  !(isset($context["browserSupported"]) || array_key_exists("browserSupported", $context) ? $context["browserSupported"] : (function () { throw new RuntimeError('Variable "browserSupported" does not exist.', 90, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 91
...
{% endblock %}
", "@PimcoreAdmin/admin/login/login.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/admin-ui-classic-bundle/templates/admin/login/login.html.twig");
    }
