...
class __TwigTemplate_fe1ba633be5afecb63669268db8f1718 extends Template
{
        ...
        if ((array_key_exists("customviews", $context) && is_iterable((isset($context["customviews"]) || array_key_exists("customviews", $context) ? $context["customviews"] : (function () { throw new RuntimeError('Variable "customviews" does not exist.', 17, $this->source); })())))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["cv"]) {
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, $context["cv"], "icon", [], "array", true, true, true, 19)) {
                    // line 20
                    yield "            ";
                    $context["treetype"] = (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["cv"], "treetype", [], "array", false, false, true, 20)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (CoreExtension::getAttribute($this->env, $this->source, $context["cv"], "treetype", [], "array", false, false, true, 20)) : ("object"));
                    // line 21
                    yield ".pimcore_";
...
", "@PimcoreAdmin/admin/misc/admin_css.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/admin-ui-classic-bundle/templates/admin/misc/admin_css.html.twig");
    }
