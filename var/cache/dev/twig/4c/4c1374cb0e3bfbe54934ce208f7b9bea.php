...
class __TwigTemplate_7f15387f1eefd1819b092ff68d203830 extends Template
{
...
<head>
    ...
    <style>
        ...
        ";
        // line 26
        if ((($tmp =  !(isset($context["thumbnailPath"]) || array_key_exists("thumbnailPath", $context) ? $context["thumbnailPath"] : (function () { throw new RuntimeError('Variable "thumbnailPath" does not exist.', 26, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 27
            yield "            #container {
                padding-top: 200px;
            }
...
<div id=\"container\">
    ";
        // line 44
        if ((($tmp = (isset($context["thumbnailPath"]) || array_key_exists("thumbnailPath", $context) ? $context["thumbnailPath"] : (function () { throw new RuntimeError('Variable "thumbnailPath" does not exist.', 44, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 45
            yield "        <a href=\"";
...
", "@PimcoreAdmin/admin/asset/get_preview_pdf_open_in_new_tab.html.twig", "/home/batpot/skeleton-project/vendor/pimcore/admin-ui-classic-bundle/templates/admin/asset/get_preview_pdf_open_in_new_tab.html.twig");
    }
