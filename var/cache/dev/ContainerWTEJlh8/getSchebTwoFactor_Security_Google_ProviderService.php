...
class getSchebTwoFactor_Security_Google_ProviderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->services['scheb_two_factor.security.google_authenticator'] ?? $container->load('getSchebTwoFactor_Security_GoogleAuthenticatorService'));
        ...
        $b = ($container->privates['scheb_two_factor.security.google.default_form_renderer'] ?? $container->load('getSchebTwoFactor_Security_Google_DefaultFormRendererService'));

        if (isset($container->privates['scheb_two_factor.security.google.provider'])) {
            return $container->privates['scheb_two_factor.security.google.provider'];
        }

        return $container->privates['scheb_two_factor.security.google.provider'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\Google\GoogleAuthenticatorTwoFactorProvider($a, $b);
    }
}
