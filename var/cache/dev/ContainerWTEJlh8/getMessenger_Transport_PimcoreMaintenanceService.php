...
class getMessenger_Transport_PimcoreMaintenanceService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.transport.pimcore_maintenance'] = $a->createTransport('doctrine://default?queue_name=pimcore_maintenance', ['transport_name' => 'pimcore_maintenance'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
